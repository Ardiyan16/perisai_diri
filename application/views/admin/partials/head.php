...
<head>
    ...
    <!-- CodeMirror -->
    <link rel="stylesheet" href="<?= base_url()?>assets/back/plugins/codemirror/codemirror.css">
    <link rel="stylesheet" href="<?= base_url()?>assets/back/plugins/codemirror/theme/monokai.css">
    <!-- SimpleMDE -->
    <link rel="stylesheet" href="<?= base_url()?>assets/back/plugins/simplemde/simplemde.min.css">
    ...
    <!-- summernote -->
    <link rel="stylesheet" href="<?= base_url() ?>assets/back/plugins/summernote/summernote-bs4.min.css">
    <script src="<?= base_url() ?>assets/back/dist/js/sweetalert2-all.js"></script>
    <script src="<?= base_url() ?>assets/back/dist/js/notif.js"></script>
</head>