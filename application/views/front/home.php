<?php $this->load->view('front/partials/head.php') ?>
<?php $this->load->view('front/partials/menu.php') ?>
...
<?php $this->load->view('front/partials/footer.php') ?>
<?php $this->load->view('front/partials/js.php') ?>